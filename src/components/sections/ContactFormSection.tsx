  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at 50% 60%, rgba(201,168,76,0.05) 0%, transparent 55%)",
        }}
      />
      ...
      <div className="relative z-10 max-w-xl mx-auto">
        ...
        >
          <p className="text-slate-600 text-sm mb-4">Wolisz szybki kontakt?</p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a
              href="tel:+48781573274"
              className="btn-phone inline-flex items-center justify-center gap-2 font-semibold px-6 py-3 rounded-xl"
            >
              <svg
                className="w-4 h-4"
                fill="none"
            ...
            <a
              ...
              className="btn-whatsapp inline-flex items-center justify-center gap-2 font-semibold px-6 py-3 rounded-xl"
            >
